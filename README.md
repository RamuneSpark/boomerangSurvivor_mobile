...
* 開発者ツール等を用いて、セーブデータ等を改造する行為はご遠慮ください。また、開発者ツール等の使用によって不具合が発生した場合、一切のサポートをすることができません。
...
このゲームは、ブラウザバックの操作によっていつでもページを離脱することができます。<br>また、再読込の操作によっていつでもゲームをリセットすることが可能です。<br>ただし、その際にゲームの進行状況などが消失した場合は、**元に戻すことはできません**のでご注意ください。<br><br>※このゲーム内でのキャンセル操作としてブラウザバックを使用することはできません。<br>※リザルト画面で最終スコアが表示されている状態に限り、画面の状況を一時保存します。SNSへのシェアの際に勝手にページの再読込が発生しても、リザルト画面を復元することができますのでご安心ください。
